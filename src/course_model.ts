...
export const ViennaGameCourse: CourseModel = {
    ...
    lines: [viennaGambitAcceptedQuiz, viennaGambitDeclinedNc6Quiz, viennaGambitAcceptedQuiz, viennaGambitDeclinedNc6Quiz, viennaGambitAcceptedQuiz, viennaGambitDeclinedNc6Quiz, viennaGambitAcceptedQuiz, viennaGambitDeclinedNc6Quiz]
}